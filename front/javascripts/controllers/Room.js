define(['./module', 'jquery'], function (controllers, $) {
    ...
    controllers.controller('RoomHeader', ['ngSocket', '$scope', '$http', '$rootScope', '$stateParams', function (ngSocket, $scope, $http, $rootScope, $stateParams) {
        ...
        $scope.functionHell2 = function () {
            var mas = [{"id": 5001, "isPlayOut": false, "isSold": true, "titlePicId": 1, "number": 1}, {
                "id": 5002,
                "isPlayOut": true,
                "isSold": false,
                "titlePicId": 2,
                "number": 2
            }, {"id": 5003, "isPlayOut": false, "isSold": false, "titlePicId": 3, "number": 3}, {
                "id": 5004,
                "isPlayOut": false,
                "isSold": false,
                "titlePicId": 4,
                "number": 4
            }, {"id": 5005, "isPlayOut": false, "isSold": false, "titlePicId": 5, "number": 5}, {
                "id": 5006,
                "isPlayOut": false,
                "isSold": false,
                "titlePicId": 7,
                "number": 6
            }, {"id": 5007, "isPlayOut": false, "isSold": false, "titlePicId": 8, "number": 7}, {
                "id": 5008,
                "isPlayOut": false,
                "isSold": false,
                "titlePicId": 9,
                "number": 8
            }, {"id": 5009, "isPlayOut": false, "isSold": false, "titlePicId": 10, "number": 9}];
        ...
        ngSocket.on('room', function (data) {
            ...
            $scope.auction_params.users_number = data.auction.users.map(function (e) {
                return e.id
            });
            ...
            currentId = $scope.auction_params.lots.map(function (e) {
                return e.isPlayOut;
            }).indexOf(true);
